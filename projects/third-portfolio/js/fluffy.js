    ...
    function FluffyObject(containerNode) {
        ...
        (function construct() {
            ...
            if (contentNode === null) {
                ...
                _('â†³ Has no [data-fluffy-content] element and therefore will be ignored.', 'warn');
                return;
            }
            ...
            if (containerNode.hasAttribute('data-fluffy-options')) {
                ...
                try {
                    ...
                    if (typeof options !== 'object') {
                        _(containerNode, 'warn');
                        _('â†³ Fluffy options need to be of type object. Skipping for container above. Using defaults instead.', 'warn');
                    ...
                    _(containerNode, 'warn');
                    _('â†³ Trying to parse options for container above has failed. Using defaults instead.', 'warn');
                }
